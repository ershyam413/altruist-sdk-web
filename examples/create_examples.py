...
def setup_react_example():
    ...
    # Add altruist-sdk-webb to dependencies in package.json
    os.system("npm install --save altruist-sdk-webb@latest react-router-dom@5.3.3")
    os.chdir("..")
...
def setup_angular_example():
    ...
    # Add altruist-sdk-webb to dependencies in package.json
    os.system("npm install --save altruist-sdk-webb@latest")
    os.chdir("..")
