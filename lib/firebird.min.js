...
0):void 0!==p.device_id&&(D=0));w("cly_id",this.device_id);w("cly_id_type",D);if(c){ka={};for(var n in this.utm)e[n]?(this.userData.set("utm_"+n,e[n]),ka[n]=e[n]):this.userData.unset("utm_"+n);this.userData.save()}ya();setTimeout(function(){Ua();f.remote_config&&f.fetch_remote_config(f.remote_config)},1);x&&document.documentElement.setAttribute("data-countly-useragent",ta());pa.sendInstantHCRequest()}};this.halt=function(){b(d.WARNING,"halt, Resetting Firebird");p.i=void 0;Wa=!p.i;V=!1;kb="/i";Sa=
