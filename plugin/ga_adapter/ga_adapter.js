...
/* global Firebird */
/*
Firebird Adapter Library for Google Analytics
*/
(function() {
    ...
    // adapter function
    window.FirebirdGAAdapter = function() {
        // hold ga instance
        ...
        var ga_countly = function() {
            gaFirebirdArray.push(arguments);
        };

        Firebird.onload.push(function(cly) {
                ...
                if (typeof c === "string") {
                    ...
                    case "send":
                        if (typeof o === "string") {
                            ...
                            // ga('send', 'pageview')
                                ...
                                if (cly._internals.store("cly_ga:page")) {
                                    Firebird.q.push(["track_pageview", cly._internals.store("cly_ga:page")]);
                                    if (window.cly_ga_test_mode) {
                            ...
                            // ga('send', 'pageview', 'page')
                                ...
                                Firebird.q.push(["track_pageview", arguments[2]]);
                                if (window.cly_ga_test_mode) {
                        ...
                        // ga('send', {hitType:.., ...})
                            ...
                            case "pageview":
                                ...
                                Firebird.q.push(["track_pageview", o.page]);
                                if (window.cly_ga_test_mode) {
                                    window.cly_ga_test_logs.push(["track_pageview", o.page]);
                                }
                                break;
                            default:
                                Firebird._internals.log("WARNING", "hitType is not recognized:[" + o.hitType + "]");
                            }
                        }
                        break;
                    case "create":
                    ...
                    case "set":
                        ...
                        // ga('set', 'dimension', 'custom data')
                            ...
                            Firebird.q.push(["userData.set", o, u]);
                            if (window.cly_ga_test_mode) {
                        ...
                        // ga('set', {key:val, anotherKey: anotherVal})
                            ...
                            Firebird.q.push(["user_details", { custom: o }]);
                            if (window.cly_ga_test_mode) {
            ...
            while (gaFirebirdArray.length) {
                var args = gaFirebirdArray.shift();
